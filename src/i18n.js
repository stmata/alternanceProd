...
const resources = {
  en: {
    translation: {
      ...
      "txt_msg_cover_letter": "Draft generated by AI based on your CV and the job offer. It's up to you to adjust it!",
  ...
  fr: {
    translation: {
        ...
        "txt_msg_cover_letter" : "Draft généré par l'IA à partir de votre CV et de l'offre. À vous de l'ajuster !",
