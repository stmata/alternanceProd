...
const resources = {
  en: {
    translation: {
      "login": "Login",
      "welcome_message": "Welcome to the SKEMA Application Alternance. Explore apprenticeship opportunities that match your skills with the power of AI. Enhance your CV with personalized recommendations and create tailored cover letters for the positions you're targeting.",
      ...
      "btn_view_Job_details": "Job details",
      "btn_apply": "Apply",
      ...
      "title_prompt": "Enter Your Role Preferences:",
      "description_prompt": "Looking for your next career opportunity? Just enter your desired criteria into our intelligent search system. Our AI-powered tool will match you with the best roles tailored to your skills and ambitions. Start your search now and discover opportunities that align with your expertise and career goals. Effortlessly find the job that’s right for you today!",
      ...
      "niveau_experiences": "Level of Education/Experience",
  ...
  fr: {
    translation: {
        ...
        "input_mail": "Saisir votre adresse mail SKEMA",
        "input_code": "Saisir le code reçu par email",
        ...
        "btn_view_Job_details": "Détails de l'emploi",
        "btn_apply": "Postuler",
        ...
        "title_JobD": "Détails de l'emploi:",
        ...
        "title_source": "Source",
        "title_region": "Régions",
        "input_search": "Indiquer une information clé",
        "title_favoris": "Favoris",
        "btn_SM": "Compléter son profil",
        "btn_MM": "Filtrer manuellement",
        ...
        "title_CV": "Télécharger votre CV pour trouver les offres qui vous correspondent",
        "description_CV": "En téléchargeant votre CV sur notre plateforme, vous accédez à un outil puissant conçu pour analyser en profondeur votre parcours académique, votre expérience professionnelle et vos compétences individuelles. Cela permet à la plateforme de vous proposer des offres parfaitement adaptées à votre profil.",
        "input_file": "Télécharger et joindre des fichiers",
        "btn_UpCV": "Télécharger ou glisser-déposer",
        "btn_processing": "Traitement en cours",
        "btn_viewRslts": "Voir les résultats du CV",
        "btn_StartM": "Rechercher",
        "title_prompt": "Dites-nous tout sur vos préférences de poste",
        "description_prompt": "À la recherche de votre prochaine opportunité professionnelle ? Il vous suffit de nous donner vos critères. Notre outil IA vous proposera les offres les plus adaptées à vos compétences et à vos objectifs professionnels. Commencez votre recherche dès maintenant et découvrez les meilleures opportunités et trouvez facilement l’emploi qui vous correspond !",
        "input_prompt": "Veuillez fournir une description détaillée du poste que vous recherchez, y compris le titre de poste souhaité, les compétences clés, les responsabilités préférées et les objectifs recherchés. Plus vos critères seront précis, mieux nous pourrons vous proposer des offres d'alternance adaptées à votre recherche.",
